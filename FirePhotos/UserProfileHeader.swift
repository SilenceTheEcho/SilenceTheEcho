...
class UserProfileHeader: UICollectionViewCell {
    ...
    let postsLabel: UILabel = {
       let label = UILabel()
        ...
        attributedText.append(NSAttributedString(string: "tasks",
    ...
    let followersLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: "troops",
                                                 attributes: [NSForegroundColorAttributeName:
                                                    UIColor.lightGray, NSFontAttributeName: UIFont.systemFont(ofSize: 14)]))
    ...
    let followingLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: "counseling",
                                                 attributes: [NSForegroundColorAttributeName:
                                                    UIColor.lightGray, NSFontAttributeName: UIFont.systemFont(ofSize: 14)]))
    ...
    let editProfileButton: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("My Task List", for: .normal)
